...
class LocalizerZH():
    ...
    translation_page_cache_percent: str = "缓存 {PERCENT:.1f}%"
    translation_page_cache_unavailable: str = "缓存 —"
    translation_page_stat_average: str = "均值吞吐"
    translation_page_stat_batches: str = "已处理批次"
    translation_page_stat_cache_hit: str = "缓存命中率"
    translation_page_stat_latency: str = "平均网络延迟"
    translation_page_open_proofreading: str = "打开平行校对台"
    translation_page_export_snapshot: str = "导出快照"
    ...
    translation_page_feed_title: str = "实时翻译流水（最近处理）"
