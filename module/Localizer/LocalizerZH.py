...
class LocalizerZH():
    ...
    proofreading_page_ai_polish: str = "AI 润色"
    proofreading_page_ai_proofread: str = "AI 校对"
    proofreading_page_quality_report: str = "质量报告"
    proofreading_page_quality_cancel: str = "停止质量任务"
    ...
    proofreading_page_quality_cancelling: str = "正在等待当前批次完成并保存 …"
    proofreading_page_quality_report_title: str = "初译质量报告"
    ...
    proofreading_page_quality_report_items: str = "选择要启动 AI 校对的报告条目"
    proofreading_page_quality_report_empty: str = "当前缓存没有记录可定位的质量失败条目"
    proofreading_page_quality_report_proofread: str = "选择并校对"
