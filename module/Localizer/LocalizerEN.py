...
class LocalizerEN(LocalizerZH):
    ...
    proofreading_page_ai_polish: str = "AI Polish"
    proofreading_page_ai_proofread: str = "AI Proofread"
    proofreading_page_quality_report: str = "Quality Report"
    proofreading_page_quality_cancel: str = "Stop Quality Task"
    ...
    proofreading_page_quality_cancelling: str = "Waiting for the current batch to finish and save …"
    proofreading_page_quality_report_title: str = "Initial Translation Quality Report"
    ...
    proofreading_page_quality_report_items: str = "Select report entries to start AI proofreading"
    proofreading_page_quality_report_empty: str = "The cache has no locatable quality-failure entries"
    proofreading_page_quality_report_proofread: str = "Select and Proofread"
