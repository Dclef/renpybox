...
class LocalizerEN(LocalizerZH):
    ...
    proofreading_page_confirm_translation: str = "Confirm Translation"
    proofreading_page_confirm_selected_translations: str = "Confirm Selected Translations"
    proofreading_page_confirm_translation_done: str = "Confirmed {COUNT} translations; click Save to persist"
